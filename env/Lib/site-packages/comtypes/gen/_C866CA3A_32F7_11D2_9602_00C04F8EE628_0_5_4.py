...
__all__ = [
    'SPBINARYGRAMMAR', '_RemotableHandle', 'DISPID_SRCEEnginePrivate',
    'DISPID_SOTRemove', 'DISPID_SPRDisplayAttributes',
    'SVSFVoiceMask', 'SP_VISEME_3', 'SDTRule',
    'ISpeechPhraseAlternates', 'SpeechTokenContext',
    'DISPID_SPRuleNumberOfElements', 'eLEXTYPE_PRIVATE9',
    'SPEI_END_SR_STREAM', 'SGRSTTRule', 'SPADAPTATIONRELEVANCE',
    'SRCS_Disabled', 'ISpeechGrammarRuleState', 'SPSHT_EMAIL',
    'SAFT8kHz8BitMono', 'DISPID_SBSWrite', 'SVPNormal',
    'DISPID_SpeechMemoryStream', 'SBONone',
    'DISPID_SRCRequestedUIType', 'SVSFParseMask', 'SASStop',
    'SPEI_HYPOTHESIS', 'SVSFUnusedFlags', 'ISpRecoContext',
    'DISPID_SRCEAudioLevel', 'ISpeechFileStream',
    'DISPID_SVSCurrentStreamNumber', 'SPVPRI_NORMAL',
    'eLEXTYPE_PRIVATE15', 'SPEI_TTS_BOOKMARK', 'SPEI_REQUEST_UI',
    'SPAUDIOBUFFERINFO', 'DISPID_SVDisplayUI',
    'eLEXTYPE_LETTERTOSOUND', 'SPSSuppressWord', 'ISpeechAudio',
    'SpeechCategoryVoices', 'SVP_0', 'DISPID_SOTCreateInstance',
    'DISPID_SpeechBaseStream', 'SDKLDefaultLocation', 'SVP_3',
    'SpeechPropertyLowConfidenceThreshold',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRSetPropertyString',
    'SRARoot', 'SAFTGSM610_8kHzMono', 'SAFT24kHz16BitMono',
    'SGSEnabled', 'SREPropertyNumChange', 'SPFM_OPEN_READONLY',
    'DISPID_SRCEventInterests', 'DISPID_SRGId',
    'DISPID_SRGCmdSetRuleState', 'SP_VISEME_1', 'DISPID_SVEWord',
    'SPEI_RESERVED2', 'SpeechAudioProperties', 'DISPID_SRCState',
    'DISPID_SRCESoundStart', 'DISPID_SLWType', 'SAFT44kHz8BitMono',
    'DISPID_SPPsCount', 'SPCT_COMMAND', 'SPPS_Modifier',
    'eLEXTYPE_PRIVATE11', 'ISpRecoContext2', 'DISPID_SMSAMMHandle',
    'DISPID_SVSpeakStream', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SVEBookmark', 'DISPID_SVGetProfiles',
    'ISpObjectTokenCategory', 'SpeechTokenKeyFiles',
    'DISPID_SRGState', 'ISpEventSource',
    'DISPID_SRSCurrentStreamNumber', 'SDTReplacement',
    'ISpeechGrammarRule', 'SAFTDefault',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRRTLength',
    'DISPID_SVSVisemeId', 'DISPID_SVEEnginePrivate', 'SPFILEMODE',
    'DISPID_SVEVoiceChange', 'DISPID_SVAlertBoundary',
    'DISPID_SDKEnumValues', 'DISPID_SOTGetStorageFileName',
    'SPEI_RESERVED1', 'eLEXTYPE_PRIVATE6', 'DISPID_SPEPronunciation',
    'SpCompressedLexicon', 'SP_VISEME_2', 'SPEVENT',
    'SPEI_END_INPUT_STREAM', 'ISpeechPhraseReplacement',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SASState', 'SVP_2',
    'SpeechPropertyResourceUsage', 'SVSFParseAutodetect',
    'DISPID_SLGetPronunciations', 'DISPID_SVAudioOutput', 'SLTUser',
    'SVSFPurgeBeforeSpeak', 'SAFT22kHz8BitMono', 'ISpeechObjectToken',
    'SAFT11kHz8BitStereo', 'SPFM_OPEN_READWRITE', 'ISpStream',
    'eLEXTYPE_PRIVATE20', 'SVSFParseSsml', 'SpeechMicTraining',
    'eLEXTYPE_PRIVATE8', 'SPINTERFERENCE_TOOSLOW',
    'SSSPTRelativeToStart', 'SSSPTRelativeToEnd', 'DISPID_SAFGuid',
    'tagSTATSTG', 'DISPID_SRRSaveToMemory', 'DISPID_SVSRunningState',
    'DISPID_SVSkip', 'DISPID_SGRSTPropertyName',
    'DISPID_SPEAudioTimeOffset', 'SGRSTTEpsilon', 'DISPID_SLWWord',
    'SPVPRI_ALERT', 'SREAudioLevel', 'SRAExport', 'SREAdaptation',
    'DISPID_SPRuleEngineConfidence', 'SAFT48kHz8BitMono',
    'SDTDisplayText', 'SpeechDisplayAttributes', 'SPSModifier',
    'eLEXTYPE_USER', 'eLEXTYPE_PRIVATE12', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SGRSTPropertyValue',
    'DISPID_SPILanguageId', 'SpSharedRecoContext',
    'DISPID_SDKSetBinaryValue', 'DISPID_SpeechAudio',
    'DISPID_SpeechGrammarRule', 'STCRemoteServer',
    'DISPID_SOTCDefault', 'DISPID_SVSInputWordPosition',
    'DISPID_SPEsItem', 'DISPID_SGRSTPropertyId',
    'DISPID_SLGetGenerationChange', 'DISPID_SRCERecognition',
    'ISpeechAudioStatus', 'DISPID_SRRecognizer',
    'DISPID_SWFESamplesPerSec', 'DISPID_SPRNumberOfElements',
    'DISPID_SABufferNotifySize', 'SGSDisabled', 'DISPID_SASetState',
    'SLODynamic', 'SPFM_NUM_MODES', 'SVP_9', 'ISpeechWaveFormatEx',
    'SPSHORTCUTPAIR', 'SPPHRASEREPLACEMENT', 'SVEWordBoundary',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpeechAudioState',
    'DISPID_SPRs_NewEnum', 'SpeechBookmarkOptions', 'ISpRecognizer',
    'SPWORDPRONOUNCEABLE', 'DISPID_SPIGetText', 'SPRECORESULTTIMES',
    'SPPS_RESERVED4', 'SRSInactive', 'SAFT12kHz8BitStereo',
    'SPPS_RESERVED2', 'SPBOOKMARKOPTIONS',
    ...
    'SPTEXTSELECTIONINFO', 'SPRECOSTATE', 'SAFT44kHz8BitStereo',
    'SpObjectToken', 'ISpRecoCategory', 'ISpLexicon',
    'DISPID_SPIEngineId', 'SPDKL_LocalMachine',
    'DISPID_SRGDictationUnload', 'DISPID_SRIsShared',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRCCreateGrammar',
    'eLEXTYPE_PRIVATE14', 'DISPID_SpeechLexicon',
    'SRTExtendableParse', 'ISpeechPhraseProperty',
    'SAFTADPCM_8kHzMono', 'SAFTNonStandardFormat', 'SPAO_NONE',
    'SpeechAllElements', 'DISPID_SVESentenceBoundary',
    'DISPID_SLPPhoneIds', 'DISPID_SPARecoResult', 'WAVEFORMATEX',
    'DISPID_SPEs_NewEnum', 'SpeechTokenShellFolder',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRCRetainedAudioFormat',
    'SPSHT_Unknown', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SABufferInfo', 'SPWF_INPUT', 'DISPID_SRGRules',
    'SAFT24kHz16BitStereo', 'SP_VISEME_17', 'STCLocalServer',
    'SP_VISEME_7', 'SPCT_SUB_DICTATION', 'SpeechRecognitionType',
    'SAFT16kHz16BitStereo', 'SDTAlternates', 'SRERecoOtherContext',
    'SVP_5', 'SPSLMA', 'DISPID_SPRsItem', 'SpShortcut',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRCVoice',
    'SVSFIsXML', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SABIBufferSize', 'SPEI_RESERVED5', 'SINoise',
    'DISPID_SRSAudioStatus', 'Speech_Default_Weight', 'SVSFParseSapi',
    'SVP_13', 'DISPID_SGRSTNextState', 'SpObjectTokenCategory',
    'SPINTERFERENCE_TOOLOUD', 'SpeechVoiceEvents',
    'DISPID_SOTDisplayUI', 'DISPID_SPRulesItem', 'ISpGrammarBuilder',
    'DISPID_SVWaitUntilDone', 'DISPID_SLAddPronunciationByPhoneIds',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SREmulateRecognition', 'ISpRecoGrammar2',
    'eLEXTYPE_RESERVED8', 'DISPID_SRGDictationSetState', 'ISpAudio',
    'SP_VISEME_16', 'ISpeechPhraseInfoBuilder', 'SPPARTOFSPEECH',
    'SECFEmulateResult', 'DISPID_SWFEBitsPerSample',
    'DISPIDSPTSI_SelectionOffset', 'ISpRecognizer3',
    'SpeechWordPronounceable', 'eLEXTYPE_RESERVED7',
    'DISPID_SRRSpeakAudio', 'DISPID_SVEStreamEnd',
    'DISPID_SRCSetAdaptationData', 'SpeechEmulationCompareFlags',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SGDSActive', 'SP_VISEME_11',
    'DISPID_SRRAudioFormat', 'DISPID_SASNonBlockingIO',
    'SpeechRuleAttributes', 'DISPID_SpeechRecognizer',
    'SPINTERFERENCE_LATENCY_WARNING', 'SP_VISEME_14',
    'DISPID_SGRSTWeight', 'DISPID_SVPriority',
    'SpeechCategoryAppLexicons', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRGetFormat', 'DISPID_SOTMatchesAttributes',
    'SpeechGrammarState', 'DISPID_SpeechGrammarRuleState',
    'SRESoundStart', 'eLEXTYPE_PRIVATE16',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SLPsItem',
    'DISPID_SRGetPropertyString', 'ISpeechPhraseProperties',
    'IInternetSecurityMgrSite', 'ISpeechGrammarRuleStateTransitions',
    'SPEI_SR_AUDIO_LEVEL', 'SVP_1', 'DISPID_SGRSTText',
    'SpeechSpecialTransitionType', 'ISpShortcut', 'DISPID_SGRSTsItem',
    'SAFT8kHz8BitStereo', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRAudioInput', 'DISPID_SOTCSetId', 'SPWORDLIST',
    'DISPID_SWFEExtraData', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SPERequiredConfidence', 'DISPID_SPPId',
    'DISPID_SDKEnumKeys', 'SPEVENTENUM', 'SAFTCCITT_uLaw_22kHzStereo',
    'SWPKnownWordPronounceable', 'eLEXTYPE_PRIVATE19',
    'DISPID_SOTCId', 'SPGRAMMARSTATE', 'SDA_Consume_Leading_Spaces',
    'SPCONTEXTSTATE', 'ISpeechPhraseRule', 'SpeechGrammarTagWildcard',
    'DISPID_SDKOpenKey', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpeechStreamFileMode', 'ISpeechVoice', 'eWORDTYPE_DELETED',
    'DISPID_SpeechRecoResult', 'SPEI_PROPERTY_NUM_CHANGE',
    'SpeechPropertyComplexResponseSpeed', 'SGSExclusive',
    'SGDSActiveUserDelimited', 'SPRULESTATE',
    'DISPID_SpeechLexiconWords', 'DISPID_SpeechVoiceStatus',
    'eLEXTYPE_PRIVATE3', 'SPPS_NotOverriden',
    'DISPID_SVSLastStreamNumberQueued', 'SPCT_DICTATION',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SGRsAdd',
    'eLEXTYPE_RESERVED10', 'DISPID_SPEAudioStreamOffset',
    'SAFT32kHz8BitMono', 'SITooFast', 'DISPID_SpeechObjectTokens',
    'ISpeechAudioFormat', 'ISpPhoneConverter',
    'DISPID_SDKGetlongValue', 'SRCS_Enabled', 'DISPID_SPCLangId',
    'SWTDeleted', 'ISpPhrase', 'SRATopLevel', 'SREStreamStart',
    'DISPID_SVEViseme', 'SRADynamic', 'SGRSTTTextBuffer',
    ...
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SpeechRecoContextEvents',
    'SAFTGSM610_44kHzMono', 'DISPID_SLWs_NewEnum', 'SPPS_Noun',
    'SPBO_TIME_UNITS', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SPRules_NewEnum', 'DISPID_SRRRecoContext', 'SVP_10',
    'DISPID_SGRAddResource', 'SpeechStreamSeekPositionType',
    'ISpeechXMLRecoResult', 'SREStreamEnd', 'SSFMOpenReadWrite',
    'SP_VISEME_4', 'STCAll', 'DISPID_SpeechDataKey', 'SPVOICESTATUS',
    'SAFTExtendedAudioFormat', 'DISPID_SRSSupportedLanguages',
    'SAFT22kHz16BitMono', '_ISpeechVoiceEvents', 'ISpProperties',
    'SITooLoud', 'DISPID_SDKSetLongValue', 'DISPID_SMSADeviceId',
    'DISPID_SLWPronunciations', 'SSTTTextBuffer',
    'SpeechEngineProperties', 'DISPID_SLGetWords',
    'SpResourceManager', 'SGDSInactive', 'SGDSActiveWithAutoPause',
    'SPRECOGNIZERSTATUS', 'DISPID_SAFSetWaveFormatEx',
    ...
    'DISPID_SRAudioInputStream', 'SPRULE', 'SpeechDiscardType',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SLAddPronunciation', 'SGRSTTWildcard', 'SPWF_SRENGINE',
    'SP_VISEME_0', 'SPBO_AHEAD', 'SPAR_Unknown',
    'DISPID_SpeechRecoResultTimes', 'SPSEMANTICERRORINFO',
    'SAFT48kHz16BitMono', 'DISPID_SPAPhraseInfo',
    'DISPID_SpeechObjectTokenCategory', 'SECFDefault',
    'SpeechCategoryPhoneConverters', 'STCInprocHandler',
    'SpSharedRecognizer', 'SpeechLexiconType',
    'DISPID_SASFreeBufferSpace', 'SPDKL_CurrentUser',
    'SDA_No_Trailing_Space', 'ISpObjectWithToken', 'SP_VISEME_20',
    'SAFTText', 'SAFTCCITT_ALaw_22kHzMono', 'SPEI_START_SR_STREAM',
    'SAFTGSM610_11kHzMono', 'ISpeechLexicon', 'SSFMOpenForRead',
    'DISPID_SLPPartOfSpeech', 'DISPID_SPIElements', 'SPWT_LEXICAL',
    'SPLO_DYNAMIC', 'SREHypothesis', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SVSLastBookmark', 'DISPID_SRCEPropertyStringChange',
    '__MIDL_IWinTypes_0009', 'DISPID_SpeechRecoContext',
    'DISPID_SPRulesCount', 'SWTAdded', 'SAFTADPCM_11kHzMono',
    'SPEI_RESERVED6', 'SAFT12kHz16BitStereo',
    'SpeechRetainedAudioOptions', 'DISPID_SPAStartElementInResult',
    'SVP_11', 'SAFT8kHz16BitMono',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SPEDisplayText',
    'SpeechTokenKeyAttributes', 'SPAUDIOOPTIONS',
    'DISPID_SRRTOffsetFromStart', 'SP_VISEME_21', 'SPCS_ENABLED',
    'SAFTCCITT_ALaw_11kHzMono', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRGCmdSetRuleIdState', 'SAFTADPCM_44kHzStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SLWsCount',
    'SP_VISEME_15', 'SPAS_CLOSED', 'SPRST_ACTIVE',
    'ISpeechRecognizer', 'ISpeechObjectTokenCategory',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpeechAudioBufferInfo',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SRCPause', 'SITooSlow',
    'SPCT_SLEEP', 'DISPID_SLGenerationId', 'SDKLCurrentUser',
    'DISPID_SCSBaseStream', 'SP_VISEME_10',
    'DISPID_SPIRetainedSizeBytes', 'SSFMCreate', 'SPEI_SOUND_START',
    'SPRS_INACTIVE', 'SAFT16kHz8BitMono', 'SpMMAudioEnum',
    'DISPID_SLPType', 'DISPID_SPEsCount', 'STSF_CommonAppData',
    'SPPHRASE', 'SVEAllEvents', 'SAFT16kHz8BitStereo',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVP_20',
    'SPSHORTCUTTYPE', 'SPVPRIORITY', 'DISPID_SPRuleChildren',
    'SGPronounciation', 'DISPID_SGRSAddRuleTransition',
    'ISpResourceManager', 'STCInprocServer', 'SVP_7',
    'DISPID_SMSGetData', '_SPAUDIOSTATE', 'eLEXTYPE_PRIVATE5',
    'SRERequestUI', 'SPSMF_UPS', 'DISPID_SRCRetainedAudio',
    'SP_VISEME_13', 'SVSFDefault', 'ISpEventSink',
    'DISPID_SRCESoundEnd', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SPIProperties', 'DISPID_SDKDeleteValue',
    'ISpeechPhoneConverter', 'DISPID_SRCVoicePurgeEvent',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SVSInputSentencePosition',
    'eLEXTYPE_VENDORLEXICON', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SVSPhonemeId', 'DISPID_SPIGrammarId', 'SVP_14',
    'SpeechVoiceSpeakFlags', 'DISPID_SpeechObjectToken',
    'DISPID_SVStatus', 'SPSVerb', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SDKSetStringValue', 'eWORDTYPE_ADDED', 'SECLowConfidence',
    'SPWT_DISPLAY', 'SPSHORTCUTPAIRLIST',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SVEAudioLevel',
    'DISPID_SpeechPhraseProperties', 'SDA_One_Trailing_Space',
    'DISPID_SRGCommit', 'SpStreamFormatConverter', 'SPAS_STOP',
    'SpeechVisemeFeature', 'SRSActiveAlways', 'SREBookmark',
    'DISPID_SPRuleFirstElement', 'DISPID_SOTIsUISupported',
    'ISpeechRecoResult', 'DISPID_SBSSeek', 'DISPID_SPPName',
    ...
    'SAFTCCITT_ALaw_11kHzStereo', 'SRTReSent',
    'DISPID_SRSetPropertyNumber', 'SVP_18',
    'DISPID_SRCERecognitionForOtherContext',
    'SPEI_START_INPUT_STREAM', 'SASPause', 'DISPID_SRGReset',
    'SPAR_Medium', 'ISpeechObjectTokens',
    'DISPID_SRSCurrentStreamPosition', 'SPEI_SR_PRIVATE',
    'DISPID_SFSClose', 'DISPID_SpeechRecognizerStatus',
    'SAFT48kHz8BitStereo', 'SpMMAudioOut',
    'DISPID_SPEEngineConfidence', 'SPEI_RESERVED3',
    'DISPID_SRCRecognizer', 'DISPID_SGRsFindRule',
    'SAFT32kHz8BitStereo', 'DISPID_SGRAttributes',
    'DISPID_SpeechPhraseElements', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SADefaultFormat', 'eLEXTYPE_PRIVATE10',
    'DISPID_SOTs_NewEnum', 'SPPHRASEPROPERTY', 'DISPID_SDKDeleteKey',
    'SPPS_Noncontent', 'SVP_16', 'SPEI_RECO_STATE_CHANGE',
    'eLEXTYPE_PRIVATE13', 'SPBO_PAUSE', 'SPSInterjection',
    'SRAInterpreter', 'ISpeechTextSelectionInformation',
    'SPEI_SR_BOOKMARK', 'DISPID_SRState', 'DISPID_SGRsCount',
    ...
    'DISPID_SWFEAvgBytesPerSec', 'ISpNotifySink',
    'SDA_Two_Trailing_Spaces', 'SVF_Emphasis', 'SAFT16kHz16BitMono',
    'SRERecognition', 'SAFT44kHz16BitStereo', 'IEnumSpObjectTokens',
    'DISPID_SVAudioOutputStream', 'SRSInactiveWithPurge',
    'DISPID_SpeechRecoResult2', 'SpeechRecoEvents', 'SGRSTTDictation',
    'DISPID_SOTRemoveStorageFileName', 'SpInProcRecoContext',
    'SPAR_Low', 'SVP_17', 'SBOPause', 'DISPID_SRCEPhraseStart',
    'DISPID_SRCCmdMaxAlternates', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRCResume', 'SPSUnknown', 'SVSFNLPMask',
    'ISpeechResourceLoader', 'SDKLCurrentConfig', 'SECHighConfidence',
    'ISpRecoResult', 'ISpeechPhraseReplacements',
    'DISPID_SRGetPropertyNumber', 'SGDisplay',
    'DISPIDSPTSI_SelectionLength', 'SPAR_High', 'SPEI_MIN_TTS',
    'SPINTERFERENCE_NONE', 'SP_VISEME_8', 'LONG_PTR',
    'DISPID_SDKGetBinaryValue', 'SPINTERFERENCE',
    'SpeechPartOfSpeech', 'DISPID_SWFEFormatTag', 'SRSEDone',
    'DISPID_SAStatus', 'ISpeechMMSysAudio', 'SpeechInterference',
    'SPEI_ADAPTATION', 'DISPID_SpeechLexiconWord', 'STSF_AppData',
    'SAFTNoAssignedFormat', 'DISPID_SGRsDynamic', 'eLEXTYPE_PRIVATE1',
    'eLEXTYPE_RESERVED6', 'DISPID_SGRAddState',
    'DISPID_SPEActualConfidence', 'DISPID_SAEventHandle',
    'SECFIgnoreKanaType', 'SPSFunction', 'SAFTCCITT_uLaw_11kHzMono',
    'SPPS_RESERVED1', 'DISPID_SPAsCount', 'SP_VISEME_19',
    'DISPID_SLPs_NewEnum', 'SVP_4', 'ISpeechCustomStream',
    'DISPID_SPEDisplayAttributes', 'SVEAudioLevel',
    'DISPID_SVEventInterests', 'SPEVENTSOURCEINFO',
    'DISPID_SpeechPhraseRule', 'SpUnCompressedLexicon',
    'SPSNotOverriden', 'SpInprocRecognizer',
    'DISPID_SPERetainedSizeBytes', 'SPWORD',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPPParent',
    'SpMMAudioIn', 'DISPID_SPPs_NewEnum', 'DISPID_SABIEventBias',
    'SSTTDictation', 'DISPID_SVSLastResult', 'SpNotifyTranslator',
    'DISPID_SVEStreamStart', 'SREPhraseStart', 'SPCATEGORYTYPE',
    'DISPID_SRGCmdLoadFromObject', 'SAFT12kHz8BitMono', 'ISpDataKey',
    'SpeechAudioVolume', 'SINoSignal', 'SITooQuiet',
    'SpeechRecognizerState', 'SAFT24kHz8BitMono', 'SPEI_SOUND_END',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SPRText',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPAS_PAUSE',
    'SpeechTokenIdUserLexicon', 'SVP_15', 'SPVISEMES', 'SGLexical',
    'DISPID_SGRInitialState', 'DISPID_SGRsCommit', 'SPEI_MIN_SR',
    'DISPID_SpeechCustomStream', 'DISPID_SPACommit',
    'SGLexicalNoSpecialChars', 'DISPID_SGRSTsCount', 'ISpeechDataKey',
    'SPEI_TTS_PRIVATE', 'DISPID_SPPConfidence',
    'ISpeechPhraseElement', 'SPDKL_DefaultLocation',
    'DISPID_SBSFormat', 'DISPID_SOTGetAttribute',
    'SWPUnknownWordPronounceable', 'SpeechPropertyResponseSpeed',
    'DISPID_SPEAudioSizeTime', 'SPFM_CREATE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechRecoResultTimes', 'SPCS_DISABLED', 'eLEXTYPE_PRIVATE7',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SGRId', 'SPDATAKEYLOCATION',
    'SpeechRunState', 'eLEXTYPE_PRIVATE4', 'DISPID_SRDisplayUI',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SLWsItem', 'SAFT44kHz16BitMono',
    ...
    'SpNullPhoneConverter', 'SP_VISEME_12', 'SPEI_PHRASE_START',
    'DISPID_SpeechPhraseReplacements', 'SAFTADPCM_22kHzStereo',
    'SRTEmulated', 'SVSFIsNotXML', 'Speech_StreamPos_Asap',
    'SVSFIsFilename', 'SVF_Stressed', 'DISPID_SVSInputWordLength',
    'DISPID_SRCEStartStream', 'DISPID_SRCAudioInInterferenceStatus',
    'SECFNoSpecialChars', 'SVEEndInputStream', 'SECFIgnoreCase',
    'SpVoice', 'DISPID_SLPSymbolic', 'ISpeechMemoryStream',
    'DISPID_SGRSTs_NewEnum', 'SpeechAudioFormatGUIDText',
    'DISPID_SFSOpen', 'SpeechGrammarTagDictation', 'SpeechLoadOption',
    'DISPID_SRRTTickCount', 'SGRSTTWord', 'DISPID_SPRFirstElement',
    'DISPID_SPRuleConfidence', 'SP_VISEME_6',
    'DISPID_SpeechAudioFormat', 'ISpeechLexiconWord', 'SLOStatic',
    'SPPS_RESERVED3', 'SpeechRecoProfileProperties',
    'ISequentialStream', 'DISPID_SOTCGetDataKey',
    'SAFT22kHz8BitStereo', 'DISPID_SRCERequestUI',
    'ISpeechPhraseAlternate', 'SPGS_EXCLUSIVE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPWORDPRONUNCIATION',
    'ISpeechLexiconPronunciation', 'SVF_None',
    'DISPID_SpeechFileStream', 'DISPID_SMSALineId',
    'SAFTCCITT_ALaw_44kHzMono', 'SRTStandard',
    'Speech_Max_Pron_Length', 'DISPID_SAFType', 'SpeechUserTraining',
    'SAFTCCITT_uLaw_44kHzMono', 'SPAS_RUN', 'DISPID_SRRPhraseInfo',
    'SPWAVEFORMATTYPE', 'SPGRAMMARWORDTYPE', 'SAFT32kHz16BitMono',
    'SPINTERFERENCE_NOISE', 'SVEViseme', 'DISPID_SpeechPhraseInfo',
    'SAFT12kHz16BitMono', 'ISpeechRecoResult2',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRRGetXMLResult',
    'UINT_PTR', 'SRTSMLTimeout', 'SpeechFormatType',
    'DISPID_SOTSetId', 'DISPID_SLPLangId', 'DISPID_SOTId',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRRTimes', 'SVEPhoneme',
    'DISPID_SPRuleName', 'SFTSREngine', 'DISPID_SGRSRule', 'SVP_6',
    'SpeechCategoryAudioOut', 'SPRST_INACTIVE', 'SDTAll',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPPChildren',
    'SpeechRegistryUserRoot', 'DISPID_SVVoice', 'SPAUDIOSTATUS',
    'SPSNoun', 'DISPID_SPIAudioSizeTime', 'SPEI_PHONEME',
    'SPEI_VISEME', 'SPEI_MAX_TTS', 'DISPID_SGRSTransitions',
    'DISPID_SWFEBlockAlign', 'SAFTCCITT_uLaw_8kHzMono', 'SVPOver',
    'SPCT_SUB_COMMAND', 'DISPID_SRRAlternates', 'SVP_19',
    'SVEBookmark', 'SVSFlagsAsync', 'SPLO_STATIC',
    ...
    'SPRST_NUM_STATES', 'SPRECOCONTEXTSTATUS',
    'DISPID_SpeechAudioStatus', 'SPPS_SuppressWord',
    'SAFTADPCM_44kHzMono', 'SPPHRASERULE', 'SPPS_LMA',
    'DISPID_SVPause', 'SPINTERFERENCE_TOOQUIET',
    'SAFT22kHz16BitStereo', 'ISpeechRecognizerStatus', 'SDTAudio',
    'SREStateChange', 'SPPS_Verb', 'SPGS_ENABLED', 'SpeechWordType',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SpeechGrammarRules',
    'SPSTREAMFORMATTYPE', 'DISPID_SRGetRecognizers',
    'SAFT48kHz16BitStereo', 'SPEI_VOICE_CHANGE',
    'DISPID_SRGDictationLoad', 'DISPID_SGRSTRule', 'SSTTWildcard',
    'DISPID_SGRClear', 'SPSMF_SAPI_PROPERTIES', 'SPGS_DISABLED',
    'SPLEXICONTYPE', 'DISPID_SpeechPhoneConverter', 'SPBO_NONE',
    'DISPID_SPIRule', 'ISpMMSysAudio', 'DISPID_SPELexicalForm',
    'SVP_21', 'ISpVoice', 'SRADefaultToActive', 'SRTAutopause',
    ...
    'SRAORetainAudio', 'SPSHT_NotOverriden', 'SpeechRuleState',
    'DISPID_SRCEFalseRecognition', 'ISpeechBaseStream',
    'SPAUDIOSTATE', 'SRESoundEnd',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPAsItem',
    'SDKLLocalMachine', 'DISPID_SRIsUISupported',
    'SpeechVoicePriority', 'SPEI_INTERFERENCE',
    'DISPID_SRCEEndStream', 'SREInterference', 'DISPID_SPCPhoneToId',
    'eLEXTYPE_RESERVED4', 'ISpeechGrammarRuleStateTransition',
    'SpAudioFormat', 'DISPID_SpeechPhraseElement',
    'Speech_Max_Word_Length', 'DISPID_SRStatus', 'SPWORDTYPE',
    'SPEI_RECOGNITION', 'DISPID_SPRsCount', 'SpeechTokenKeyUI',
    'DISPID_SDKGetStringValue', 'SpeechCategoryAudioIn', 'SLTApp',
    'DISPID_SPPsItem', 'DISPID_SPPValue', 'DISPID_SpeechVoice',
    'ISpRecoGrammar', 'DISPID_SRCEBookmark', 'SPXRO_SML',
    'SPPS_Unknown', 'ISpNotifySource', 'SPWORDPRONUNCIATIONLIST',
    'SAFT24kHz8BitStereo', 'SAFTADPCM_22kHzMono', 'SpCustomStream',
    'SRAONone', 'DISPID_SRProfile', 'SRAImport', 'SPPS_Interjection',
    'DISPID_SVGetVoices', 'SVSFPersistXML', 'DISPID_SVEPhoneme',
    'ISpSerializeState', 'SWPUnknownWordUnpronounceable',
    'DISPID_SpeechPhraseAlternates', 'SSFMCreateForWrite',
    'DISPID_SVIsUISupported', 'DISPID_SWFEChannels',
    'DISPID_SpeechWaveFormatEx', 'SpPhoneConverter', 'SFTInput',
    'SpStream', 'SECNormalConfidence', 'SVEPrivate',
    'eLEXTYPE_PRIVATE18', 'DISPID_SGRSAddSpecialTransition',
    'SAFT8kHz16BitStereo', 'DISPID_SPIReplacements',
    'DISPID_SRCBookmark', 'SDTPronunciation',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SGRsCommitAndSave',
    'SINone', 'SVP_12', 'ISpeechRecoContext', 'SPVPRI_OVER',
    'SPPHRASEELEMENT', 'ISpeechGrammarRules', 'IEnumString',
    'DISPIDSPTSI', 'DISPID_SRGIsPronounceable', 'DISPID_SDKCreateKey',
    'DISPID_SVVolume', 'ISpNotifyTranslator', 'STSF_FlagCreate',
    'SpWaveFormatEx', 'SPSERIALIZEDRESULT',
    'DISPID_SPPEngineConfidence', 'SPPROPERTYINFO', 'DISPID_SPRuleId',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SAVolume', 'ISpPhraseAlt',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPDKL_CurrentConfig',
    'ISpStreamFormat', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SVGetAudioOutputs', 'ISpeechLexiconWords',
    'SAFTGSM610_22kHzMono', 'SASRun', 'SAFTADPCM_11kHzStereo',
    'DISPID_SPIStartTime', 'SPPS_Function', 'SpFileStream',
    'DISPID_SRCEAdaptation', 'SpeechPropertyAdaptationOn',
    'DISPID_SASCurrentSeekPosition', 'SVEVoiceChange',
    'SAFTCCITT_uLaw_22kHzMono', 'SPSHT_OTHER', 'SVPAlert',
    'SpPhoneticAlphabetConverter', 'DISPID_SpeechPhraseProperty',
    'SASClosed', 'SPSEMANTICFORMAT', 'DISPIDSPRG',
    'DISPID_SpeechVoiceEvent', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SPRuleParent', 'ISpStreamFormatConverter',
    'SpeechAddRemoveWord', 'ISpObjectToken', 'tagSPPROPERTYINFO',
    'eLEXTYPE_PRIVATE2', 'DISPID_SpeechLexiconProns',
    'DISPID_SLWLangId', 'SECFIgnoreWidth', 'SPEI_MAX_SR',
    'DISPID_SVResume', 'ISpPhoneticAlphabetSelection',
    'DISPID_SGRs_NewEnum', 'DISPID_SPIGetDisplayAttributes',
    'SPEI_TTS_AUDIO_LEVEL', 'SREPrivate', 'DISPID_SRCEInterference',
    'SpeechGrammarRuleStateTransitionType', 'STSF_LocalAppData',
    'ISpeechRecoGrammar', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SVRate', 'DISPID_SPEAudioSizeBytes', 'eLEXTYPE_APP',
    'IStream', 'SDTProperty', 'SpeechGrammarWordType',
    'DISPID_SLRemovePronunciation', 'SpeechVisemeType',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SBSRead',
    'DISPID_SPIAudioSizeBytes', 'SPFM_CREATE_ALWAYS',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SGRName',
    'SP_VISEME_18', 'DISPID_SRGRecoContext',
    'DISPID_SpeechAudioBufferInfo', 'IInternetSecurityManager',
    'ISpeechPhraseInfo', 'SPEI_UNDEFINED', 'SAFTCCITT_ALaw_8kHzMono',
    'SREAllEvents', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SRRAudio',
    'SAFTADPCM_8kHzStereo', 'DISPID_SPAs_NewEnum',
    'DISPID_SMSSetData', '_ISpeechRecoContextEvents',
    'SPXRO_Alternates_SML', 'SpeechDataKeyLocation',
    'SPSERIALIZEDPHRASE', 'SVEStartInputStream', 'DISPID_SOTsItem',
    'DISPID_SGRSTType', 'DISPID_SPCIdToPhone', 'SVP_8',
    'SPWT_PRONUNCIATION', 'SpeechCategoryRecognizers',
    'ISpXMLRecoResult', 'DISPID_SRGCmdLoadFromFile', 'SPRS_ACTIVE',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SOTsCount',
    'DISPID_SVGetAudioInputs', 'SP_VISEME_5',
    'SpeechRecoContextState', 'DISPID_SRCCreateResultFromMemory',
    'SVSFNLPSpeakPunc', 'DISPID_SPISaveToMemory',
    'SAFT11kHz16BitMono', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SOTGetDescription', 'SpeechVoiceSkipTypeSentence',
    'SVESentenceBoundary', 'SPXMLRESULTOPTIONS', 'SP_VISEME_9',
    'SRSActive', 'Speech_StreamPos_RealTime'
]

_check_version('1.2.0', 1697034537.154551)
